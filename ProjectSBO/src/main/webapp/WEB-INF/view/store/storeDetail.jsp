...
<%@ taglib prefix="fm" uri="http://java.sun.com/jsp/jstl/fmt" %>  
 <div id="wrap">
	<nav>
		...
		<h1 id="store_name" class="store_name"
			data-store_name="${info.storeName }">${info.storeName }</h1>
		...
		<div class="inf">
			...
			<!-- 관리자 페이지 일때 처리, 가게 수정 및 메뉴 수정 등의 메뉴 -->
			<c:if test="${adminPage && SPRING_SECURITY_CONTEXT.authentication.principal.user.role == 'ROLE_ADMIN' }">
				...
				<button class="delete_menu">매뉴 삭제</button>
			</c:if>
		</div>
	</nav>
