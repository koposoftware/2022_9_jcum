...
<!-- 		    	<input type="hidden" name="score" class="score" >
				...
				<div id="info" style="display: none;">
					<span style="color:red;">아래 정보가 맞으면 제출버튼을 클릭해주세요.</span>
				</div>
		</div>
	    	...
	    	<div id="btn_box">
	    		...
	    		<input type="hidden" class="store_id" name="storeId">
	 			...
	 			<!-- <button type="submit" class="review_submit_btn" disabled >제출</button> -->
	 			<button type="button" class="review_submit_btn" disabled >제출</button>
